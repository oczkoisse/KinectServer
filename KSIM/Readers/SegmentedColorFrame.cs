        ...
        public override void Serialize(Stream s)
        {
            ...
            using (BinaryWriter writer = new BinaryWriter(s))
            {
                ...
                if (Segmented)
                {
                    ...
                    //colorData = getSegmentedFrame(colorData, xStartInFrame, yStartInFrame, xEndInFrame, yEndInFrame);
                    //compressToJPG(SegmentedWidth, SegmentedHeight);
                    croppedColorDataBitMap = colorDataBitmap.Clone(crop, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
                    ...
                    writer.Write(compressedColorDataStream.ToArray());// compressedColorData.ToArray());
